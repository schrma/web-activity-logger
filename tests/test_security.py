def test___access_register___no_logging___not_allowed(
    test_client, init_database, register_a_person
...
def test___access_register___admin_logging___ok(
    test_client, log_in_admin_user, register_a_person
):  # pylint: disable='unused-argument'
...
def test___access_register___normal_logging___not_allowed(
    test_client, log_in_normal_user, register_a_person
):  # pylint: disable='unused-argument'
...
def test___access_admin___admin_logging___user_role_available(
    test_client, log_in_admin_user
):  # pylint: disable='unused-argument'
    log_in_admin_user  # pylint: disable='pointless-statement'
...
def test___access_addmin___normal_logging___user_role_not_available(
    test_client, log_in_normal_user
):  # pylint: disable='unused-argument'
    log_in_normal_user  # pylint: disable='pointless-statement'
    response = test_client.get("/admin", follow_redirects=True)
...
def test___access_addmin___no_logging___user_role_not_available(
    test_client,
):  # pylint: disable='unused-argument'
    response = test_client.get("/admin", follow_redirects=True)
