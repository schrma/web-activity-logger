...
def test___valid_login_logout___with_user___login_accepted(test_client, init_database):
    """
    GIVEN a Flask application configured for testing
...
def test___valid_login_logout___with_incorrect_user___login_not_accepted(test_client, init_database):
    """
    GIVEN a Flask application configured for testing
    WHEN the '/login' page is posted to (POST)
    THEN check the response is valid
